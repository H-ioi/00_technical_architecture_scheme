<template>
  <div class="filebox df_aw">
    <div class="fileboxitem" v-for="(item, index) in filelistobj" :key="index">
      ...
      <el-tooltip v-if="showName" :content="item.name" effect="dark" placement="bottom">
    ...
    <div>
      ...
      >
        <!-- <i class="el-icon-plus avatar-uploader-icon"></i>
		 -->
        <img class="upload-photo-icon" src="/community/upload_picture.png" />
      </el-upload>
    </div>
    <p class="tips_text">
      {{ tipsText }}
...
import { downloadFile, uploadFile, getFileList, deleteFile } from "@/api/upload/index.js";
export default {
  name: "UniUiFilelist",
  props: {
    scene: String,
  ...
  data() {
    return {
      ...
      dialogVisible: false,
      currentName: "",
      imgType: ["png", "jpg", "jpeg", "bmp", "gif", "webp", "psd", "svg", "tiff"],
    };
  },
