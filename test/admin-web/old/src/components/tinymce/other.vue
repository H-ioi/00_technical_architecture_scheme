<template>
  <div>
    <Editor id="tinymces" v-model="value" :init="init"></Editor>
  </div>
</template>
...
export default {
  ...
  data() {
    const _this = this;
    return {
      // url: "http://218.19.163.250:11237",
      // url: "http://218.19.163.250:11254",
      url: process.env.VUE_APP_BASE_URL,
      value: "",
      contenyt: {},
      init: {
        selector: "#tinymces", //tinymce的id
        ...
        toolbar:
          "fontselect fontsizeselect  lineheight forecolor backcolor bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | image quicklink blockquote  numlist bullist preview fullscreen", //工具栏
