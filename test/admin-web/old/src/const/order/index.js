export const order = {
  ...
  orderType: [
    ...
    {
      label: "搬运服务", enLabel: "Relocation Request", value: "2", add: "/order/carry/add",
      edit: "/order/carry/edit",
      detail: '/order/carry/detail',
    },
    {
      label: "巡检工单", enLabel: "Inspect Request", value: "3", add: "/order/inspect/add",
      edit: "/order/inspect/edit",
      detail: '/order/inspect/detail',
    },
    {
      label: "维修工单", enLabel: "Repair Request", value: "4", add: "/order/repair/add",
      edit: "/order/repair/edit",
      detail: '/order/repair/detail',
    },
    {
      label: "点检工单", enLabel: "Spot Check Request", value: "5", add: "/order/spotcheck/add",
      edit: "/order/spotcheck/edit",
      detail: '/order/spotcheck/detail',
    },
    {
      label: "保养工单", enLabel: "UPKEEP Request", value: "6", add: "/order/upkeep/add",
