<template>
  ...
  >
    <el-form-item style="width: 15%">
      <el-input
        v-model="searchFrom['isaParentCode']"
        placeholder="ISA家长ID"
        clearable
        @clear="search"
      ></el-input>
    ...
    <el-form-item class="search_form_btn" style="width: auto; margin-right: 0">
      ...
      >
        ...
        >
          ...
          <el-form-item style="width: 24%">
            <el-input
              v-model="searchFrom['studentName']"
              placeholder="学生姓名"
              clearable
              @clear="search"
            ></el-input>
          ...
          <el-form-item style="width: 24%">
            <el-select
              style="width: 100%;"
              v-model="searchFrom['relationships']"
              clearable
              filterable
              placeholder="与学生关系"
              @clear="search"
            >
              <el-option
                v-for="(i, k) in isaData['relationships']"
                :key="k"
                :label="i.label"
                :value="i.value"
              ></el-option>
          ...
          <el-form-item style="width: 24%">
            <el-select
              style="width: 100%;"
              v-model="searchFrom['isContactParental']"
              clearable
              filterable
              placeholder="是否主监护人"
              @clear="search"
