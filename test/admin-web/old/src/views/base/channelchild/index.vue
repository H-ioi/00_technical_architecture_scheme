      ...
      <div class="moadlFromBox">
        ...
        >
          <div class="df_center_wrap">
            <el-form-item label="名称" style="width: 80%" prop="label">
              <el-input v-model="ruleForm['label']"></el-input>
            </el-form-item>
            <el-form-item label="排序" style="width: 80%" prop="label">
              <el-input v-model="ruleForm['sort']"></el-input>
            </el-form-item>
            <el-form-item label="渠道" style="width: 80%" prop="label">
              <el-select
                style="width: 100%;"
                clearable
                multiple
...
export default {
  ...
  data() {
    return {
      ...
      type: "",
      showremark: true,
      ruleForm: { label: "", sort: "", pid: [] },
      rules: {},
      contentType: "enquiry_channel_child_one",
      contentLabel: "",
      attributeTableData: []
    };
  },
  ...
  methods: {
    ...
    fetchChannellist() {
      fetchTypeList("enquiry_channel").then(res => {
        console.log("res.data", res.data);
        let data = res.data.data;
        if (data == null) return;
        this.enquiryChannel = data;
      });
    },
    getDictFieldAll() {
