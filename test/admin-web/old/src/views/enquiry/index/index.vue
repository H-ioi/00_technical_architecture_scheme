    ...
    <div class="df_sb palyTableBox">
      <div class="df_sb">
        <div class="df_sb">
          ...
          >
          <el-button
            v-if="permissions['enquiry_all_template_download']"
            type="primary"
            size="medium"
          ...
          <el-button
            type="primary"
            v-if="
              permissions['enquiry_all_enter_cotice'] &&
                currentstatus == '1' &&
                currentstatus != '0'
            "
            size="medium"
          ...
          <el-button
            type="primary"
            v-if="
              permissions['enquiry_all_status_batch_enter'] &&
                currentstatus == '1' &&
                currentstatus != '0'
            "
            size="medium"
...
export default {
  ...
  methods: {
    ...
    playTab(name, item, scope) {
      ...
      switch (name) {
        case "look":
          this.$router.push("/enquiry/detail?clueId=" + item.id + "&type=1");
          break;
        case "close":
    ...
    rowClick(row, column, event) {
      this.$router.push("/enquiry/detail?clueId=" + row.id + "&type=1");
    },
    // 上传
    beforeUpload(file) {
    ...
    search() {
      ...
      this.searchData["creatorIds"] = this.searchFrom["creatorIds"];
      this.searchData["followerIds"] = this.searchFrom["followerIds"];
