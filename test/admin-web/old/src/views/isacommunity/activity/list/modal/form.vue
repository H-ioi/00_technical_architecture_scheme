<template>
  <el-form ref="ruleForm" :label-position="'top'" :model="ruleForm" :rules="rules" class="activity-form" :class="{
    ...
    'activity-form--readonly': readonly,
  }">
    <fieldset class="activity-form-fieldset" :disabled="readonly">
      <div class="activity-form-body">
        ...
        <el-row :gutter="16">
          ...
          <el-col :xs="24" :sm="12" :md="6">
            <el-form-item :label="$t('isagroup.票价')" prop="ticketPrice">
              <el-input-number v-model="ruleForm.ticketPrice" :precision="0" :step="0.01" :min="0"
        ...
        <el-row :gutter="16">
          ...
          <el-col :xs="24" :sm="12" :md="6">
            <el-form-item :label="$t('isagroup.推送校区')" prop="wechatPushSchoolIds">
              <el-select clearable collapse-tags v-model="ruleForm['wechatPushSchoolIds']"
                :placeholder="$t('common.请选择')" multiple>
                <el-option :key="k" v-for="(i, k) in schoolSelectList" :label="schoolDropdownLabel(i)"
                  :value="i.id"></el-option>
              </el-select>
            </el-form-item>
        ...
        <el-row :gutter="16" type="flex" align="middle" class="activity-form__row--limit-scope">
          <el-col :xs="24" :span="12">
            <el-form-item :label="$t('isagroup.报名人数限制')" prop="registrationLimit" class="activity-form-item--row-label">
          ...
          <el-col :xs="24" :span="12">
            <el-form-item :label="$t('isagroup.可见范围名单')"
              ...
              <div class="visible-scope-file-actions">
                ...
                <el-upload class="visible-scope-upload" :action="uploadAction" :show-file-list="false"
                  accept=".xlsx,.xls" :disabled="!ruleForm.id" :http-request="handleImportVisibleScope">
                  <el-button size="small" icon="el-icon-upload2" :disabled="!ruleForm.id">{{ $t("isagroup.上传可见范围名单")
                  }}</el-button>
                </el-upload>
...
.activity-form {
  ...
  .activity-form-body {
    ...
    /* 本行表单项：标签与控件同一行（覆盖 el-form 的 label-top + 子项 100% 宽） */
      ...
      ::v-deep .el-form-item.activity-form-item--row-label .el-form-item__label {
      ...
      ::v-deep .el-form-item.activity-form-item--row-label .el-form-item__content {
