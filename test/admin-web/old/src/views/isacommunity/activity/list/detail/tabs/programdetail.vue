        ...
        <div class="item_info">
          ...
          <div class="item_info_box">
            ...
            <div class="item_info_value">
              <img
                width="200px"
                :src="item.programInfo.backgroundImage"
                alt=""
              />
            </div>
          </div>
          ...
          >
            ...
            <div
              class="df_warp"
              style="width: 100%"
              v-for="(prize, k) in (item.bindInfo && item.bindInfo.prizeList) ||
              []"
              :key="'prize-' + index + '-' + k"
            >
      ...
      try {
        ...
        for (const item of list) {
          ...
          if (programInfo.programType == 2) {
            const voteRaw = await getVoteProgram({ programId: item.id });
            const voteList = Array.isArray(voteRaw) ? voteRaw : [];
