<template>
  <div class="community_page">
    ...
    <div class="community_centent">
      <div class="orderDetail">
        <div class="orderDetail_item">
          ...
          <div class="orderDetail_baseinfo" style="padding-top: 0 !important" v-if="programData.programType == 1">
            <div style="margin-bottom: 15px" class="orderDetail_baseinfo_item">
          ...
          <div class="orderDetail_baseinfo" style="padding-top: 0 !important" v-if="programData.programType == 2">
            <div style="margin-bottom: 15px" class="orderDetail_baseinfo_item">
          ...
          <div class="orderDetail_baseinfo" style="padding-top: 0 !important" v-if="programData.programType == 3">
            <div style="margin-bottom: 15px" class="orderDetail_baseinfo_item">
        ...
        <div class="orderDetail_item" v-if="programData.programType == 1">
          ...
          <div class="orderDetail_baseinfo">
            <div class="isa_table">
              <Table ref="Table" :showSelection="false" :tableTitle="tabletitle['activityPrizeTable']"
                :tableData="prizeList" :tableBtn="prizeBtn" @playTab="playPrizeTab" />
            </div>
          </div>
        </div>
        <div class="orderDetail_item" v-if="programData.programType == 1 && programData.createLotteryPool == '1'">
          <div class="orderDetail_item_title df_sb">
            <div>
              {{ $t("isagroup.奖池") }}
            </div>
            <div class="df_align_center">
              ...
              <el-upload style="height: 32px; line-height: 32px; margin-left: 10px" class="upload-demo" action=""
                :before-upload="beforeUpload" :show-file-list="false" :limit="1">
          ...
          <div class="orderDetail_baseinfo">
            <div class="isa_table">
              <Table ref="Table" :showSelection="false" :tableTitle="tabletitle['lotteryPoolFilesTable']"
                :tableData="poolFilesList" :tableBtn="poolFilesBtn" @playTab="playPoolFilesTab" />
            </div>
          </div>
        </div>
        <div class="orderDetail_item" v-if="programData.programType == 2">
          ...
          <div class="orderDetail_baseinfo">
            <div class="isa_table">
              <Table ref="Table" :showSelection="false" :tableTitle="tabletitle['voteProgramTable']"
                :tableData="voteList" :tableBtn="voteBtn" @playTab="playVoteTab" />
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- 编辑项目弹窗 -->
    <PrizForm ref="PrizForm" @getList="getProgramPrizeList" :isBind="true" :bindProgramId="programId" />
    <!-- 编辑节目弹窗 -->
    <VoteProgramForm ref="VoteProgramForm" @getList="getVoteProgram" :isBind="true" :bindProgramId="programId" />
  </div>
</template>
