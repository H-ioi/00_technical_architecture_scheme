      ...
      >
        ...
        <div class="formgenerator_template">
          <div class="formgenerator_item">
            <div class="formgenerator_itemname">{{ $t("consult.基本属性") }}</div>
            ...
            >
              ...
              >
                <el-select
                  ...
                  style="width: 100%"
                >
                  <el-option :label="$t('consult.有效')" :value="1"> </el-option>
                  <el-option :label="$t('consult.失效')" :value="0"> </el-option>
                </el-select>
              </el-form-item>
              <el-form-item
    ...
    submitForm() {
      this.$refs["templateFrom"].validate((valid) => {
        if (valid) {
          ...
          let formData = this.$refs.FormgeneratorActivity.setFormgeneratorData();
          if (formData["isPass"]) {
