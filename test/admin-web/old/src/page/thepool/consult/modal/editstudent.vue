      ...
      <div class="moadlFromBox">
        ...
        >
          ...
          <div class="df_center_wrap" style="max-height: 600px; overflow-y: auto">
            ...
            <el-form-item :label="$t('consult.来源')" prop="origin" style="width: 25%">
              <el-input
      ...
      <div class="moadlFromBox">
        ...
        >
          ...
          <div class="df_center_wrap">
            <el-form-item :label="$t('consult.姓')" prop="lastName" style="width: 25%">
              <el-input
            ...
            <el-form-item :label="$t('consult.名')" prop="firstName" style="width: 25%">
              <el-input
            ...
            <el-form-item :label="$t('consult.性别')" prop="sex" style="width: 25%">
              <el-select
      ...
      <div class="moadlFromBox">
        ...
        >
          ...
          <div class="df_center_wrap">
            ...
            <el-form-item :label="$t('consult.邮箱')" prop="email" style="width: 25%">
              <el-input
            ...
            <el-form-item :label="$t('consult.电话')" prop="phone" style="width: 25%">
              <el-input
            ...
            <el-form-item :label="$t('consult.微信号')" prop="wechat" style="width: 25%">
              <el-input
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        sex: [{ required: true, message: that.$t("consult.请选择"), trigger: "blur" }],
        enrollYear: [
