<template>
  <div class="orderDetail">
    <div class="orderDetail_btn" v-if="currentOrderStatus == 1">
      <el-button
        v-if="isMy ? true : permissions['order_inspect_edit']"
        type="primary"
        size="medium"
    ...
    <div class="orderDetail_btn" v-if="currentOrderStatus == 2">
      <el-button
        v-if="isMy ? hasMyAuthority : permissions['order_inspect_edit']"
        type="primary"
        size="medium"
        @click="editOrder('edit')"
        >编辑</el-button
    ...
    <div class="orderDetail_content">
      ...
      <div class="orderDetail_item">
        ...
        <div class="orderDetail_baseinfo">
          ...
          <div class="orderDetail_baseinfo_item">
            <span>巡检类型</span>
            <span :title="OrderData['inspectTypeName']">{{
              OrderData["inspectTypeName"]
            }}</span>
          </div>
          <div class="orderDetail_baseinfo_item">
            <span>关联空间</span>
