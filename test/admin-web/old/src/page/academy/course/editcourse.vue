      ...
      >
        ...
        <el-scrollbar class="formItem">
          <div class="df_center_wrap">
            <el-form-item label="课程中文名称" prop="nameCn">
              <el-input
                v-model="from.nameCn"
                placeholder="请输入"
                :maxlength="100"
            ...
            <el-form-item label="课时" prop="classHour">
              <el-input-number
                style="width: 100%;"
                v-model="from.classHour"
                placeholder="请输入"
                :min="0"
                :precision="0"
              ></el-input-number>
            </el-form-item>
            <el-form-item label="支持课程人数" prop="supportNum">
              <el-input-number
                style="width: 100%;"
            ...
            <el-form-item label="可补充课程人数" prop="supplementNum">
              <el-input-number
                style="width: 100%;"
            ...
            <el-form-item label="课程价格(RMB/元)" prop="price">
              <el-input-number
                style="width: 100%;"
                v-model="from.price"
                placeholder="请输入"
            ...
            <el-form-item style="width: 100%" label="课程状态" prop="release">
            ...
            <el-form-item
              ...
              prop="coverFileIds"
            >
              <CoverFile ref="coverFile" :scene="'isaic_course_cover'" />
            </el-form-item>
            <el-form-item
              style="width: 100%"
              label="二维码"
            ...
            >
              <QrCodeFile
                ref="qrCodeFile"
                :scene="'isaic_course_signup_success_qr_code'"
                :limit="1"
              />
            </el-form-item>
            <el-form-item
            ...
            <!-- <el-form-item v-if="!hasLeader" style="width: 80%" label="绑定课程">
              <BindTransfer
                ref="courseChild"
                :ignoreId="currentId"
                :type="type"
...
import BindTransfer from "./bindtransfer.vue";
import {
  getCourseChild,
  getCourseDetail,
  addCourse,
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        grade: [{ required: true, message: "请输入", trigger: "blur" }],
        teachingTime: [{ required: true, message: "请选择", trigger: "blur" }],
          ...
          if (this.$route.query.type == "add") {
            addCourse(data).then(res => {
              if (res.data.success) {
                ...
                this.$router.push("/academy/course/course");
              }
            });
          } else {
