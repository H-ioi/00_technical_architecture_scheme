    ...
    <div class="formgenerator thepool_page" style="height: 100%">
      <div class="formgenerator_item" v-if="hasTemplateFrom">
        ...
        >
          ...
          <el-form-item :label="$t('consult.英文名')" prop="enlabel" style="margin: 0">
            <el-input
              style="width: 380px"
        ...
        <div class="formgenerator_left">
          <div class="formgenerator_template">
            ...
            <div style="padding: 20px 20px 0; text-align: right">
              ...
              <el-button type="primary" size="medium" round @click="saveTemplate">{{
                $t("consult.保存")
              }}</el-button>
            </div>
          </div>
...
import { addTemplate, editTemplate, getTemplateInfo } from "@/api/consult/template.js";
  ...
  methods: {
    ...
    setFormgeneratorData() {
      ...
      let data = {
        ...
        templateName: this.templateFrom.label ? this.templateFrom.label : "模板表单",
