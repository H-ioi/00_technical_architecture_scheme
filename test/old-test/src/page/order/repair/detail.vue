<template>
  <div class="orderDetail">
    <div class="orderDetail_btn" v-if="currentOrderStatus == '1'">
      <el-button
        v-if="isMy ? true : permissions['order_repair_edit']"
        type="primary"
        size="medium"
    ...
    <div class="orderDetail_btn" v-if="currentOrderStatus == '2'">
      <el-button
        v-if="isMy ? hasMyAuthority : permissions['order_repair_edit']"
        type="primary"
        size="medium"
        @click="editOrder('edit')"
        >编辑</el-button
    ...
    <div class="orderDetail_content">
      ...
      <div class="orderDetail_item">
        ...
        <div class="orderDetail_baseinfo baseinfo">
          ...
          <div class="orderDetail_baseinfo_item">
            <span>维修类型</span>
            <span :title="OrderData['repairTypeName']">{{
              OrderData["repairTypeName"]
            }}</span>
          </div>
          <div class="orderDetail_baseinfo_item">
            <span>维修费用(RMB)</span>
            <span :title="OrderData['cost']">{{ OrderData["cost"] }}</span>
          </div>
          <div class="orderDetail_baseinfo_item">
            <span>关联空间</span>
