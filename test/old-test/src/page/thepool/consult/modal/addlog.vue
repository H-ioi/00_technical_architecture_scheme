      ...
      <div class="moadlFromBox">
        ...
        >
          <div class="df_center_wrap">
            ...
            <el-form-item :label="$t('consult.学生')" prop="studentId" style="width: 50%">
              <el-select
            ...
            <el-form-item style="width: 60%" :label="$t('consult.附件')">
              <FileList ref="filelist" :scene="'enquiry_enroll'" :isDisabled="false" />
            </el-form-item>
          </div>
  ...
  watch: {
    showAddLog: {
      handler(newVal) {
        if (newVal) {
          // 使用 dayjs 获取并格式化当前时间
          this.ruleForm.followTime = dayjs().format("YYYY-MM-DD HH:mm:ss");
        }
      },
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          let data = {
            ...
            guardianId: this.ruleForm.guardianId,
