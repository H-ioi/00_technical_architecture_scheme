<template>
  <div>
    <el-form label-position="top" ref="form" :model="form" :rules="rules">
      <div class="form_item_title">Basic Details 基本信息</div>
      ...
      <div class="form_item_title">Full Name 学生护照全名: as per passport</div>
      ...
      <el-form-item :label="$t('consult.证件号码')" prop="identityCard">
        <el-input
      ...
      <div class="form_item_title">Language Profile 语言信息</div>
      ...
      <div class="form_item_title">Home Address in China 中国家庭住址</div>
