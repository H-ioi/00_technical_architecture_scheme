      ...
      >
        ...
        <el-scrollbar class="formItem">
          <div class="df_center_wrap">
            <el-form-item label="俱乐部中文名称" prop="nameCn">
              <el-input
                v-model="from.nameCn"
                placeholder="请输入"
                :maxlength="100"
            ...
            <el-form-item label="俱乐部英文名称" prop="nameEn">
              <el-input
                v-model="from.nameEn"
                placeholder="请输入"
                :maxlength="100"
            ...
            <el-form-item label="学生理事" prop="studentCouncil">
              <el-input
                v-model="from.studentCouncil"
                placeholder="请输入"
                :maxlength="100"
              ></el-input>
            </el-form-item>
            <el-form-item label="指导老师" prop="academicAdvisor">
              <el-input
                v-model="from.academicAdvisor"
                placeholder="请输入"
                :maxlength="100"
              ></el-input>
            </el-form-item>
            <el-form-item label="支持俱乐部人数" prop="supportNum">
              <el-input-number
                style="width: 100%;"
            ...
            <el-form-item label="可补充俱乐部人数" prop="supplementNum">
              <el-input-number
                style="width: 100%;"
            ...
            <el-form-item label="俱乐部价格(RMB/元)" prop="price">
              <el-input-number
                style="width: 100%;"
                v-model="from.price"
                placeholder="请输入"
            ...
            <el-form-item style="width: 100%" label="俱乐部状态" prop="release">
            ...
            <el-form-item
              ...
              prop="coverFileIds"
            >
              <CoverFile ref="coverFile" :scene="'isaic_club_cover'" />
            </el-form-item>
            <el-form-item
              style="width: 100%"
              label="二维码"
            ...
            >
              <QrCodeFile
                ref="qrCodeFile"
                :scene="'isaic_club_signup_success_qr_code'"
                :limit="1"
              />
            </el-form-item>
            <el-form-item
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          let data = _.cloneDeep({
            ...
            courseIds: this.$refs["courseChild"].bindSelectionId,
            activityIds: this.$refs["activityChild"].bindSelectionId,
            competitionIds: this.$refs["competitionChild"].bindSelectionId
          });
          if (this.$route.query.type == "add") {
            addClub(data).then(res => {
              if (res.data.success) {
                this.$message({
                  type: "success",
                  message: "新增成功"
                ...
                this.$router.push("/academy/course/club");
              }
            });
          } else {
            data["id"] = this.$route.query.id;
            putClub(data).then(res => {
              if (res.data.success) {
                this.$message({
                  type: "success",
                  message: "保存成功"
    ...
    getDetail(id) {
      getClubDetail(id).then(res => {
        ...
        if (res.data.success) {
          ...
          let { courses, activitys, competitions, type } = data;
          ...
          this.from = {
            ...
            studentCouncil: data["studentCouncil"],
            academicAdvisor: data["academicAdvisor"],
            sort: data["sort"]
          };
          this.$nextTick(() => {
            ...
            if (courses) {
              this.$refs["courseChild"].initData(courses);
            }
            if (activitys) {
              this.$refs["activityChild"].initData(activitys);
            }
            if (competitions) {
              this.$refs["competitionChild"].initData(competitions);
            }
          });
        }
      });
