      ...
      >
        ...
        <el-scrollbar class="formItem">
          <div class="df_center_wrap">
            <el-form-item label="活动中文名称" prop="nameCn">
              <el-input
                v-model="from.nameCn"
                placeholder="请输入"
                :maxlength="100"
            ...
            <el-form-item label="支持活动人数" prop="supportNum">
              <el-input-number
                style="width: 100%;"
            ...
            <el-form-item label="可补充活动人数" prop="supplementNum">
              <el-input-number
                style="width: 100%;"
            ...
            <el-form-item label="活动价格(RMB/元)" prop="price">
              <el-input-number
                style="width: 100%;"
                v-model="from.price"
                placeholder="请输入"
            ...
            <el-form-item style="width: 100%" label="活动状态" prop="release">
            ...
            <el-form-item
              ...
              prop="coverFileIds"
            >
              <CoverFile ref="coverFile" :scene="'isaic_activity_cover'" />
            </el-form-item>
            <el-form-item
              style="width: 100%"
              label="二维码"
            ...
            >
              <QrCodeFile
                ref="qrCodeFile"
                :scene="'isaic_activity_signup_success_qr_code'"
                :limit="1"
              />
            </el-form-item>
            <el-form-item
          ...
          if (this.$route.query.type == "add") {
            addActivity(data).then(res => {
              if (res.data.success) {
                ...
                this.$router.push("/academy/course/activity");
              }
            });
          } else {
            data["id"] = this.$route.query.id;
            putActivity(data).then(res => {
              if (res.data.success) {
                this.$message({
                  type: "success",
                  message: "保存成功"
