<template>
  ...
  <el-form-item>
    ...
    <el-table :data="dataList" :header-cell-style="headercellstyle"  v-loading="dataListLoading"
      @selection-change="selectionChangeHandle" style="width: 100%; font-size: 14px;">
      <el-table-column prop="flowDefId" header-align="center" align="center" :label="$t('attendance.流程定义ID')" show-overflow-tooltip
        width="200px">
      </el-table-column>
      <el-table-column prop="flowDefName" header-align="center" align="center" :label="$t('attendance.流程名称')" show-overflow-tooltip
        width="200px">
      </el-table-column>
      <el-table-column prop="userName" header-align="center" align="center" :label="$t('attendance.发起人')" show-overflow-tooltip
        width="200px">
      </el-table-column>
      ...
      <el-table-column prop="startDate" header-align="center" align="center" :label="$t('attendance.发起时间')" show-overflow-tooltip
        width="200px">
      </el-table-column>
      <el-table-column prop="endDate" header-align="center" align="center" :label="$t('attendance.结束时间')" show-overflow-tooltip
        width="200px">
      </el-table-column>

      <el-table-column prop="flowProceId" header-align="center" align="center" :label="$t('attendance.实例ID')" show-overflow-tooltip
        width="200px">
      </el-table-column>
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" :label="$t('attendance.操作')">
        <template slot-scope="scope">
          ...
          <el-button type="text" size="small" @click="showFlowHandle(scope.row.flowProceId)">{{ $t('attendance.查看流程进度')
            }}</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="$t('attendance.流程审批')" :visible.sync="dialogVisible" width="30%">
    ...
    <el-dialog :title="$t('attendance.流程图')" :visible.sync="dialogActiveVisible" width="80%">
      ...
      <div style="margin-left: 40px;">
        ...
        <el-steps direction="vertical">
          <el-step v-for="item in hiTasks" :key="item.id" :status="item.status" :description="item.remark"
            :title="item.taskNodeName + '  审批人:' + item.assigneeName + '   ' + item.startTime"
