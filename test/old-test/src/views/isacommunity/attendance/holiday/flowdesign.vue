        ...
        <div class="form-container">
          <el-form :model="formConfig" ref="formConfig" label-width="120px" :rules="formRules">
            ...
            <el-form-item label="流程类型" prop="type">
              <el-select v-model="formConfig.type" placeholder="请选择流程类型" style="width: 250px">
                <el-option label="请假流程" value="holiday"></el-option>
                <el-option label="销假流程" value="holiday2"></el-option>
              </el-select>
            </el-form-item>
          <el-form-item label="流程名称" prop="name">
            ...
            <el-form-item label="学校" prop="schools">
              <el-select v-model="formConfig.schools" placeholder="请选择学校" multiple clearable>
                <!-- 动态加载学校列表 -->
                <el-option 
            ...
            <el-form-item label="请假类型" prop="leaveType">
              <el-select v-model="formConfig.leaveType" placeholder="请选择请假类型" clearable>
...
import { postFlowDef, getFlowModelef, getSchoolList } from '@/api/isacommunity/holiday'
// 需要引入右侧属性栏的相关依赖
// 这里引入的是右侧属性栏这个框
