      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane :label="$t('isagroup.活动基本信息')" name="activityInfo">
          <el-scrollbar :style="{ height: scrollHeight }">
            <ActivityDetail :activityId="activityId" ref="activityInfo" />
          </el-scrollbar>
        </el-tab-pane>
        <el-tab-pane :label="$t('isagroup.活动项目')" name="activityProgram">
          <el-scrollbar :style="{ height: scrollHeight }">
            <ProgramDetail :activityId="activityId" ref="activityProgram" />
          </el-scrollbar>
        </el-tab-pane>
...
export default {
  name: "teacher",
  components: { ActivityDetail, ProgramDetail },
  data() {
    return {
      consts: consts,
