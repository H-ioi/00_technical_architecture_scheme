<template>
  <div class="community_page">
    ...
    <div class="community_centent">
        ...
        <el-form class="df_align_center" :label-position="'top'" :inline="true" :model="searchFrom">
          ...
          <el-form-item style="width: 200px">
            <el-input clearable style="width: 100%" v-model="searchFrom['keyword']"
              :placeholder="$t('isagroup.微信AppID')"></el-input>
          </el-form-item>
      ...
      <div class="isa_table">
        <Table ref="Table" :showSelection="true" :tableTitle="tabletitle['wechatSchoolInfoTable']"
...
<script>
import { delWechatSchoolInfo, getWechatInfoPage } from "@/api/isacommunity/wechatSchoolInfo.js";
