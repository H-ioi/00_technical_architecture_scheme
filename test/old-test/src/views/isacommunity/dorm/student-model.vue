          ...
          <el-row class="detail-row">
            ...
            <el-col :span="9">
              ...
              <span class="detail-value">
                {{ studentInfo.gender === '1' || studentInfo.gender === 1 ? $t('dorm.男') : (studentInfo.gender === '2' || studentInfo.gender === 2 ? $t('dorm.女') : studentInfo.gender || '-') }}
              </span>
            </el-col>
          </el-row>
          <el-row class="detail-row">
        ...
        <div class="detail-section">
          ...
          <el-row class="detail-row">
            <el-col :span="24">
              ...
              <span class="detail-value">{{ studentInfo.room_room || '-' }}</span>
            </el-col>
          </el-row>
          <el-row class="detail-row">
            <el-col :span="24">
              <span class="detail-label">{{ $t('dorm.床位') }}:</span>
              <span class="detail-value">{{ detailData.bed_label || '-' }}</span>
            </el-col>
          </el-row>
          ...
          <el-row class="detail-row">
            <el-col :span="24">
              ...
              <span class="detail-value">{{ studentInfo.project_name || '-' }}</span>
            </el-col>
          </el-row>
            ...
            <el-col :span="24">
              ...
              <span class="detail-value">{{ detailData.checkin_date || '-' }}</span>
            </el-col>
          </el-row>
          ...
          <el-row class="detail-row">
            <el-col :span="24">
              <span class="detail-label">{{ $t('dorm.预计退宿日期') }}:</span>
              <span class="detail-value">{{ detailData.planned_checkout_date || '-' }}</span>
            </el-col>
          </el-row>
          ...
          <el-row class="detail-row">
            <el-col :span="24">
              ...
              <span class="detail-value">{{ detailData.payment_status === '1' || detailData.payment_status === 1 ? $t('dorm.已缴费') : $t('dorm.未缴费') }}</span>
            </el-col>
          </el-row>
        </div>
...
<script>
import {  getStudentDetail } from '@/api/isacommunity/dorm'
    ...
    dialogVisible(val) {
      if (val) {
        ...
        if (this.detailData && this.detailData.admission_no) {
          getStudentDetail({ admissionNo: this.detailData.admission_no }).then(res => {
            if (res) {
