  ...
  <div>
    ...
    <div class="isa_table">
      <Table
        ref="Table"
        :showSelection="true"
        :tableTitle="tabletitle['busStationTable']"
        :tableData="tableData"
        :tableBtn="tableBtn"
        @playTab="playTab"
        @rowClick="rowClick"
    ...
    <Detail
      ref="Detail"
      :title="$t('isagroup.详情')"
      :detailInfo="tabletitle['busStationTable']"
    ...
    formatData() {
      this.tableData.map((item) => {
        ...
        item["showStationName"] =
          this.i18nlocel == "en" ? item["enName"] : item["cnName"];
      });
    },
    ...
    delData() {
      ...
      if (selectionId.length == 0) {
        ...
        this.$alert(this.$t("isagroup.确定要删除吗？"), this.$t("isagroup.删除"), {
          ...
          delStation({ ids: selectionId }).then((res) => {
            if (res.data.success) {
