              ...
              <div class="batchupload_text">
                ...
                <div class="batchupload_btn_box">
                  <div
                    ...
                    v-if="permissions['busstation_download']"
...
import { importStation, downloadStationTemplate } from "@/api/isacommunity/station.js";
...
export default {
  ...
  methods: {
    ...
    // 下载模板
    downloadTemplate() {
      downloadStationTemplate().then((res) => {
        console.log("res", res);
        this.$message.success(this.$t("schoolbus.成功"));
