...
export default [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import(
            "@/views/isacommunity/activity/questionnaire/templateform.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            "@/views/isacommunity/activity/questionnaire/templateresult.vue"
          ),
      },
      ...
      },
      {
        ...
        component: () =>
          import("@/views/isacommunity/content/announcement/index.vue"),
      },
      {
        ...
        component: () =>
          import("@/views/isacommunity/content/article/list/index.vue"),
      },
    ],
  },
];
