...
export default [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "views" */ "@/page/order/spotcheck/detail"
          ),
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "views" */ "@/views/order/periodic/plan/index"
          ),
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "views" */ "@/views/orderuser/user/index"
          ),
      },
      {
        path: "/orderuser/visit/index",
        name: "访问列表",
        meta: {
          keepAlive: true,
        },
        component: () =>
          import(/* webpackChunkName: "views" */ "@/views/oms/visit/index"),
      },
      {
        ...
        component: () =>
          import(/* webpackChunkName: "views" */ "@/views/oms/visit/form"),
      },
      {
