...
export default [
    ...
    children: [
      {
        path: "index",
        name: "用户管理",
        component: () => import(/* webpackChunkName: "views" */ "@/page/user"),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "page" */ "@/page/thepool/activity/questionnaire/index"
      ),
  },
  {
    path: "/thepool/templateout/student",
    name: "学生填报",
    meta: {
      keepAlive: true,
      isTab: false,
    ...
    component: () =>
      import(
        /* webpackChunkName: "page" */ "@/page/thepool/templateout/student.vue"
      ),
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "page" */ "@/page/thepool/activity/questionnaire/success"
      ),
  },
  {
