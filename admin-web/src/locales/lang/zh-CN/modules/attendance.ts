...
export default {
  ...
  holiday: {
    ...
    deleteSuccess: '删除成功',
    cancelReturn: '销假',
    cancelReturnTitle: '销假申请',
    confirmCancelReturn: '确认销假',
    cancelReturnOk: '销假已提交',
    returnProof: '返校证明',
    infoAccurate: '以上信息属实',
    ruleReturnTime: '请选择返校时间',
    ruleReturnAttach: '请上传附件',
    ruleInfoAccurate: '请勾选以上信息属实',
    returnFileTooLarge: '文件大小不能超过 2MB',
