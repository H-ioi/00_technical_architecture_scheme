<template>
  <el-dialog
    v-model="visible"
    :title="$t('attendance.wechatNotice.actions.detail')"
    width="880px"
    destroy-on-close>
...
import type { AttendanceWechatNoticeRecord } from '@/types/modules/attendance-wechat-notice'

const visible = defineModel<boolean>('visible', { required: true })

const props = defineProps<{
  source: AttendanceWechatNoticeRecord | null
