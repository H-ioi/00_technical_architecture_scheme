...
import { DEMO_DASHBOARD_STATS, type DashboardStatsPayload } from '../static-demo-stats'
...
const stats = () => props.stats ?? DEMO_DASHBOARD_STATS
...
const refreshCharts = () => {
  ...
  const ld = buildLeaveDomainOption(payload, {
