<template>
  <el-dialog v-model="visible" :title="t('layout.changePasswordTitle')" :width="width" :destroy-on-close="destroyOnClose">
...
const effectiveLoading = computed(() => (managed.value ? innerLoading.value : props.loading))
