<template>
  <main class="uni-login-page">
      ...
      <el-card class="uni-login-page__card" shadow="never">
        ...
        <el-form ref="formRef" :model="formModel" :rules="formRules" label-position="top">
          ...
          <el-form-item :label="$t('common.password')" prop="password">
            <el-input v-model="formModel.password" :placeholder="$t('login.passwordPlaceholder')" show-password type="password" @keyup.enter="submitLogin" />
          </el-form-item>
    ...
    <UniLoginSecurityVerifyDialog v-model:visible="verifyVisible" :captcha-client="captchaClient" @success="loginWithCaptcha" />
  </main>
</template>
...
const props = withDefaults(
  defineProps<{
    ...
    loginRequest: (payload: { username: string; password: string; captchaVerification: string; randomStr: string }) => Promise<void>
  }>(),
  {
    logoText: 'ISA',
