...
import type { UniPaginationConfig, UniTableRequest, UniTableRequestResult } from '@/types/uni-table'
...
export function useData(options: UseDataOptions) {
  ...
  const actualLoading = computed(() => options.getLoading() || innerLoading.value)
