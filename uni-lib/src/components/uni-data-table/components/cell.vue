...
const option = computed(() => resolveOption(props.value, props.column, props.valueEnums))
const displayValue = computed(() => formatTableCellText(props.row, props.column, props.value, props.rowIndex, props.valueEnums, t))
