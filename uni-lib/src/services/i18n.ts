...
const defaultMessages: UniI18nMessages = {
  "zh-CN": {
    ...
    "dataTable.otherSettings": "其他设置",
    "dataTable.stripe": "斑马纹",
    "dataTable.border": "带边框",
    "dataTable.fixed": "固定",
    ...
    "upload.maxTotalSize": "文件总大小不能超过 {size} bytes",
    "upload.accept": "文件类型必须符合 {accept}",
    ...
    "layout.oldPassword": "原密码",
    "layout.newPassword": "新密码",
    "layout.confirmPassword": "确认密码",
    "layout.oldPasswordRequired": "请输入原密码",
    "layout.newPasswordRequired": "请输入新密码",
    "layout.confirmPasswordRequired": "请再次输入新密码",
    "layout.passwordMinLength": "密码长度不少于 6 位",
    "layout.passwordMismatch": "两次输入的新密码不一致",
    "layout.reset": "重置",
    "layout.cancel": "取消",
    "layout.submit": "提交",
  },
  en: {
    ...
    "dataTable.otherSettings": "Other settings",
    "dataTable.stripe": "Stripe",
    ...
    "upload.maxTotalSize": "Total file size cannot exceed {size} bytes",
    "upload.accept": "File type must match {accept}",
    ...
    "layout.oldPassword": "Current password",
    "layout.newPassword": "New password",
    "layout.confirmPassword": "Confirm password",
    "layout.oldPasswordRequired": "Enter current password",
    "layout.newPasswordRequired": "Enter new password",
    "layout.confirmPasswordRequired": "Confirm new password",
    "layout.passwordMinLength": "Password must be at least 6 characters",
    "layout.passwordMismatch": "New passwords do not match",
    "layout.reset": "Reset",
